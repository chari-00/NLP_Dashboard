...
import { User, ChevronDown, Upload, Settings, Bookmark, LogOut } from "lucide-react";
...
const AdminNavbar = () => {
  ...
  return (
    <nav className="flex justify-between items-center px-6 py-3 border-b border-borderGrey bg-white">
      <div className="font-bold text-primaryPurple text-xl">Admin</div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="flex items-center bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200 font-medium">
          <Settings size={16} className="mr-2" /> Manage Accounts
        </button>
